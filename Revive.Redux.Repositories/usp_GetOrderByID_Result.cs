...
namespace Revive.Redux.Repositories
{
    ...
    public partial class usp_GetOrderByID_Result
    {
        ...
        public string CustomerDocPath { get; set; }
        public Nullable<int> NoOfMachinesDelivered { get; set; }
        public Nullable<int> SoftwareVersionId { get; set; }
        public string AccountManagerName { get; set; }
        public Nullable<int> RemainingMachinesToBeMapped { get; set; }
    }
}
